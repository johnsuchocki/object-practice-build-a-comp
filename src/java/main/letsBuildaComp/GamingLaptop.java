...
public class GamingLaptop extends Computer implements Laptop {
	...
	public GamingLaptop(int ram, Storage storage, GPU gpu, MoBo mobo, CPU cpu, Case compCase, Monitor monitor,
	...
	public void powersUp() {
		if (psu >= 650) {
			...
			System.out.println("You will need a bigger power supply.  Try something 650W or larger.");
		}
	}
